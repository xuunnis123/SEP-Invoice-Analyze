...
if __name__ == '__main__':
    ...
    button102=Button(text="104",command=lambda:fun_shot1("104"),bg='#FF0088')
    button102.place(x=40, y= 100)
    button103=Button(text="105",command=lambda:fun_shot1("105"),bg='#FF3333')
    button103.place(x=70, y= 100)
    button104=Button(text="106",command=lambda:fun_shot1("106"),bg='#FF0088')
    button104.place(x=100, y= 100)
    button105=Button(text="107",command=lambda:fun_shot1("107"),bg='#FF3333')
    button105.place(x=130, y= 100)
    button106=Button(text="108",command=lambda:fun_shot1("108"),bg='#FF0088')
    button106.place(x=160, y= 100)
    button107=Button(text="109",command=lambda:fun_shot1("109"),bg='#FF3333')
    ...
    button102=Button(text="104",command=lambda:fun_shot2("104"),bg='#CCCCFF')
    button102.place(x=260, y= 100)
    button103=Button(text="105",command=lambda:fun_shot2("105"),bg='#5555FF')
    button103.place(x=290, y= 100)
    button104=Button(text="106",command=lambda:fun_shot2("106"),bg='#CCCCFF')
    button104.place(x=320, y= 100)
    button105=Button(text="107",command=lambda:fun_shot2("107"),bg='#5555FF')
    button105.place(x=350, y= 100)
    button106=Button(text="108",command=lambda:fun_shot2("108"),bg='#CCCCFF')
    button106.place(x=380, y= 100)
    button107=Button(text="109",command=lambda:fun_shot2("109"),bg='#5555FF')
